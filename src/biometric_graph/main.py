from biometric_graph import (
    BiometricGraph,
    fill_biometric_graph_from_image,
    unclutter_biometric_graph,
    merge_near_vertices,
    biometric_graph_registration
)
import os
import cv2
...
def main():
    data_path = "/home/krzychu/Documents/Studia/polska/semestr4/ASD/src/biometric_graph/Images"
    img_level = "easy"
